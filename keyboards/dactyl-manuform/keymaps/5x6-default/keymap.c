  ...
  // left hand
   ...
   KC_LSHIFT, KC_Z,    KC_X,    KC_C,   KC_V,   KC_B,
        ...
        // right hand
                     ...
                     KC_H,    KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENTER,
                     KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSHIFT, KC_RSHIFT,
                                      KC_LBRC, KC_RBRC,
  ...
  // left hand
   ...
   RESET,    _______,  _______,  _______,  _______,  _______,
        ...
        // right hand
                     ...
                     KC_PGUP,  KC_HOME,  KC_UP,    KC_END,   _______,  KC_F12, _______,
                     KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RIGHT, _______, _______, _______,
                     KC_CALC,  KC_MAIL,  KC_MYCM,  KC_WHOM,  _______,   RESET, _______,
                                         _______,  _______,
        KC_SPC, LT(_FN, KC_BSPC), 
        CTL_T(KC_PGUP), KC_PGDN,
        KC_LALT, KC_LGUI),
